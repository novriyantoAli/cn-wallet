...
const (
	PaylaterStatusActive    PaylaterStatus = "active"
	PaylaterStatusSuspended PaylaterStatus = "suspended"
	PaylaterStatusClosed    PaylaterStatus = "closed"
)
...
type PaylaterAccount struct {
	...
	Status         PaylaterStatus `gorm:"type:varchar(20);not null" json:"status"`
