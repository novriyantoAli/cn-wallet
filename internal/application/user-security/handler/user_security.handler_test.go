...
func setupUserSecurityHandler() (*UserSecurityHandler, *testutil.MockUserSecurityService) {
	gin.SetMode(gin.TestMode)
	mockService := &testutil.MockUserSecurityService{}
	logger := testutil.NewSilentLogger()
	handler := NewUserSecurityHandler(mockService, logger)
	return handler, mockService
}

func TestUserSecurityHandler_SetPIN(t *testing.T) {
	t.Run("should set PIN successfully", func(t *testing.T) {
		// Setup
		handler, mockService := setupUserSecurityHandler()
	...
	t.Run("should return bad request for invalid JSON", func(t *testing.T) {
		// Setup
		handler, _ := setupUserSecurityHandler()
...
func TestUserSecurityHandler_VerifyPIN(t *testing.T) {
...
func TestUserSecurityHandler_GetSecurity(t *testing.T) {
